...
icons.addEventListener('click',(e)=>{
    icons.classList.contains('fa-spin') ?icons.classList.remove('fa-spin')  :icons.classList.add('fa-spin')
...
if( window.localStorage.getItem('change-color')){
    document.documentElement.style.setProperty('--main-color', window.localStorage.getItem('change-color'))
...
let option_backgroundYesOrNo = window.localStorage.getItem('option_backgroundYesOrNo')

if(option_backgroundYesOrNo !== null){

    backgroundOption = option_backgroundYesOrNo    
+6
